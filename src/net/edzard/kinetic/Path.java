...
/**
 * Defines a path using a variety of drawing commands. Paths are used to define
 * custom shapes. The path object uses command chaining, which enables you to
 * specify complete paths by using combined statements. For example: new
 * Path().beginPath().moveTo(new Vector2d(200,50)).lineTo(new
 * Vector2d(420,80)).quadraticCurveTo(new Vector2d(300, 100), new Vector2d(260,
 * 170)).closePath();
 * 
 * @author Ed
 * @see CustomShape
...
public class Path {
	...
	/**
	 * Command for creating a new subpath with the given point. No connection to
	 * the previous position is made.
	 * 
	 * @author Ed
	 */
	...
	/**
	 * Command for marking the current subpath as closed, and starting a new
	 * subpath using the same point as the one for the end of the newly closed
	 * subpath.
	 * 
	 * @author Ed
	 */
	...
	/**
	 * Command for adding the given point to the current subpath and connecting
	 * it to the previous one by a straight line.
	 * 
	 * @author Ed
	 */
	...
	/**
	 * Command for adding the given point to the current subpath and connecting
	 * to the previous one by a quadratic Bezier curve with one given control
	 * point.
	 * 
	 * @author Ed
	 */
	...
	/**
	 * Command for adding the given point to the current subpath and connecting
	 * to the previous one by a cubic Bezier curve with two given control
	 * points.
	 * 
	 * @author Ed
	 */
	public class BezierCurveCommand extends Command {
		 ...
		 *            Control point 2
		 * @param pos
		 *            The position to draw a curve to
		 */
		 ...
		 * 
		 * @param cp1
		 *            The control point 1 for the curve
		 */
		 ...
		 * 
		 * @param cp2
		 *            The control point 2 for the curve
		 */
	...
	/**
	 * Command for adding an arc with the given two position points and radius
	 * to the current subpath and connecting it to the previous point by a
	 * straight line.
	 * 
	 * @author Ed
	 */
	public class ArcToCommand extends Command {
		 ...
		 * 
		 * @param pos
		 *            A position point for drawing the arc
		 */
	...
	/**
	 * Command for adding points to the subpath such that the arc described by
	 * the circumference of the circle described by the arguments, starting at
	 * the given start angle and ending at the given end angle, going in the
	 * given direction (defaulting to clockwise), is added to the path,
	 * connected to the previous point by a straight line. This sounds
	 * complicated. It's not. Try it.
	 * 
	 * @author Ed
	 */
	public class ArcCommand extends Command {
		 ...
		 *            The end angle
		 * @param clockwise
		 *            Control direction. True is clockwise, False is
		 *            anti-clockwise
		 */
		public ArcCommand(Vector2d pos, double radius, double startAngle,
		 ...
		 * 
		 * @param pos
		 *            A position for drawing the arc
		 */
		public void setPosition(Vector2d pos) {
			this.pos = pos;
		}
		 ...
		 * 
		 * @param clockwise
		 *            Set to true if drawing should occur clockwise. Otherwise,
		 *            set to False.
		 */
	...
	/**
	 * Command for adding a new closed subpath to the path, representing the
	 * given rectangle.
	 * 
	 * @author Ed
	 */
	...
	/**
	 * Closes a path. Multiple sub-paths can be created on a single path.
	 * 
	 * @return this (for command chaining)
	 */
	 ...
	 * 
	 * @param pos
	 *            The position to draw a line to
	 * @return this (for command chaining)
	 */
	...
	/**
	 * Adding the given position to the current path and connects it to the
	 * previous one by a quadratic Bezier curve with one given control point.
	 * 
	 * @param pos
	 *            The new position to add to the path
	 * @param cp
	 *            The single control point for the bezier curve
	 * @return this (for command chaining)
	 */
	...
	/**
	 * Adding the given position to the current path and connects it to the
	 * previous one by a quadratic Bezier curve with two given control point.
	 * 
	 * @param pos
	 *            The new position to add to the path
	 * @param cp1
	...
	/**
	 * Adds an arc with the given two position points and radius to the current
	 * path and connects it to the previous position by a straight line.
	 * 
	 * @param pos1
	 *            First position point for the arc
	 * @param pos2
	 *            Second position point for the arc
	 * @param radius
	 *            The arc's radius
	 * @return this (for command chaining)
	 */
	...
	/**
	 * Adds an arc with the given position to the path such that the
	 ...
	 * the previous position by a straight line. This sounds complicated. It's
	 * not. Try it.
	 * 
	 * @param pos
	 *            Postion for the arc
	 ...
	 * @param clockwise
	 *            Direction for drawing of the arc. True means clockwise. False
	 *            means anti-clockwise.
	 * @return this (for command chaining)
	 */
	public Path arc(Vector2d pos, double radius, double startAngle,
			double endAngle, boolean clockwise) {
		commands.add(new ArcCommand(pos, radius, startAngle, endAngle,
				clockwise));
		return this;
	}
		...
		for (Command c : commands) {
			switch (c.type) {
				...
				case LINE:
					...
					sb.append("L" + ltc.getPosition().x + ','
							+ ltc.getPosition().y);
					break;
				case MOVE:
					MoveToCommand mtc = (MoveToCommand) c;
					sb.append("M" + mtc.getPosition().x + ','
							+ mtc.getPosition().y);
					break;
				default:
