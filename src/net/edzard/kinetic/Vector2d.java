...
/**
 * Stores a two-dimensional value. Used for positions and sizes (horizontal and
 * vertical extents).
 * 
 * @author Ed
 */
public class Vector2d implements Serializable {
	...
	/**
	 * Default Ctor. Both components are initialized with {@link Double#NaN}.
	 */
	public Vector2d() {
	...
	/**
	 * Parametrized Ctor. Initializes vector with separate components
	 * 
	 * @param x
	 *            Initial x component value
	 * @param y
	 *            Initial y component value
	 */
	...
	/**
	 * Parametrized Ctor. Initializes vector with another vector.
	 * 
	 * @param other
	 *            The other vector
	 */
	 ...
	 * 
	 * @param val
	 *            A serialized vector. Either an array with two components or an
	 ...
	 * 
	 * @param newValue
	 *            A vector that defines the new values
	 */
	 ...
	 * 
	 * @param x
	 *            x component of the other vector
	 * @param y
	 *            y component of the other vector
	 */
	...
	/**
	 * Scale the vector's length. This keeps the direction, but alters the
	 * vector's length.
	 * 
	 * @param amount
	...
	public final double angle(final Vector2d other) {
		return Math.acos((x * other.x + y * other.y)
				/ ((Math.sqrt(x * x + y * y)) * Math.sqrt(other.x * other.x
						+ other.y * other.y)));
	}
