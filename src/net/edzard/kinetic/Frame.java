...
/**
 * Encapsulates timing information. Used for custom drawing functions. Necessary
 * for properly timed animations.
 * 
 * @author Ed
 */
public class Frame {
	 ...
	 * @param time
	 *            Timestamp of current frame (milliseconds)
	 * @param timeDiff
	 *            Difference between time stamps (milliseconds)
	 */
