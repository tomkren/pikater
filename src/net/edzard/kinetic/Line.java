...
/**
 * A line object. Consists of a number of points, which are connected using
 * straight lines. Lines can have a style (e.g. they can be dashed).
 * 
 * @author Ed
 */
public class Line extends Shape {
	...
	public enum LineStyle {
		 ...
		 * 
		 * @param dashes
		 *            Initialize with a certain setting of dashes
		 */
	...
	/**
	 * Line cap definitions. They control how line ends are displayed.
	 * 
	 * @author Ed
	 */
	public enum LineCap {
	...
	/**
	 * Retrieve first point of the line shape. Convenience method.
	 * 
	...
	/**
	 * Retrieve the last point of the line shape. Convenience method.
	 * 
	...
	/**
	 * Retrieve definition of the line style. Line styles are defined by a list
	 * of numbers defining the length of a dash, followed by the length of a
	 * gap.
	 * 
	 ...
	 * 
	 * @param dashes
	 *            The line style: a list of numbers defining the length of a
	 *            dash, followed by the length of a gap.
	 */
