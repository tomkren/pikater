...
/**
 * Base class for all visible objects. Contains functionality for:
 * <ul>
 * <li>Mouse and touch position detection
 * <li>Managing paint properties (stroke colour, width, fills, line joins,
 * shadow)
 * </ul>
 * 
 * @author Ed
...
public abstract class Shape extends Node {
	 ...
	 *            The image pattern
	 */
	// TODO: Wait for fix from Kinetic guy (3.9.7 seems to be buggy when setting
	// a pattern fill on a previously solid filled shape)
	 ...
	 *            The linear gradient fill style
	 */
	 ...
	 * 
	 * @param fct
	 *            Will be called whenever Kinetic decides to redraw the shape
	 */
	// TODO: find out if this substitutes default drawing behaviour or is called
	// in addition to it.
