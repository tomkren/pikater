...
public class Container extends Node {
	...
	/**
	 * Retrieve a child node of this container. The following selectors are
	 * supported:
	 * <ul>
	 * <li>Use '#' to select a node by a previously assigned unique ID (e.g.
	 * '#foo')
	 ...
	 * @param node
	 *            The other node
	 * @return True, if this container is a parent of the other node. False,
	 *         otherwise.
	 */
