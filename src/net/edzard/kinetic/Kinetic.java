...
/**
 * Factory class for creating Kinetic objects. Use methods from this class to
 * create Kinetic objects. This class has some default settings that can be
 * overridden. Once overriden, all subsequently created objects will use the new
 * defaults.
 * 
 * @author Ed
 */
public class Kinetic {
	...
	public static native String getVersion() /*-{
												return $wnd.Kinetic.version;
												}-*/;

	/**
	 * Create a node with JSON string. De-serialization does not generate custom
	 ...
	 *            The DOM element that Kinetic should use
	...
	/**
	 * Create a stage with JSON string. De-serialization does not generate
	 * custom shape drawing functions, images, or event handlers (this would
	 * make the serialized object huge). If your app uses custom shapes, images,
	 * and event handlers (it probably does), then you need to select the
	 * appropriate shapes after loading the stage and set these properties via
	 * on(), setDrawFunc(), and setImage() methods
	 */
	public static native final Node createStage(String json,
	 ...
	 *            The DOM element that Kinetic should use
	 * @param stageWidth
	 *            The stage's horizontal extent
	 * @param stageHeight
	 *            The stage's vertical extent
	 * @return A stage object.
	 * @see Stage
	 */
	public static native Stage createStage(Element stageContainer,
	...
	/**
	 * Create a layer object. The layer will be independent and needs to be
	 * added to a stage.
	 * 
	...
	/**
	 * Create a layer object. This method also adds the layer to a given stage.
	 * 
	 * @param stage
	 *            The stage to add the layer to
	 * @return A new layer object
	 * @see Layer
	 */
	 ...
	 *            The initial position
	 * @param radius
	 *            The radius of the elipse (x and y component)
	 * @return The ellipse shape
	 * @see Ellipse
	 */
	public static native Ellipse createEllipse(Vector2d position,
			Vector2d radius) /*-{
	 ...
	 * 
	 * @param position
	 *            The initial position and extent.
	 ...
	 *            The initial position
	 * @param img
	 *            The image to use (no inlined image urls)
	 * @return An image shape
	 * @see Image
	 */
	public static native Image createImage(Vector2d position,
	 ...
	 *            The initial position
	 * @param img
	 *            The image to use for the sprite frames
	 * @param animationKey
	 *            The initial animation key
	 * @param frames
	 *            Definition of the animation sequences using croping boxes on
	 *            the given image
	 * @return A sprite object
	 * @see Sprite
	 */
	public static Sprite createSprite(Vector2d position,
			com.google.gwt.user.client.ui.Image img, String animationKey,
			Map<String, List<Box2d>> frames) {
	 ...
	 * @see Sprite
	 */
	private static native Sprite createSprite(Vector2d position,
			com.google.gwt.user.client.ui.Image img, String animationKey) /*-{
	 ...
	 *            The initial position
	 * @param res
	 *            The image resource to use for the sprite frames
	 * @param animationKey
	 *            The initial animation key
	 * @param frames
	 *            Definition of the animation sequences using croping boxes on
	 ...
	 * @see Sprite
	 */
	public static Sprite createSprite(Vector2d position, ImageResource res,
			String animationKey, Map<String, List<Box2d>> frames) {
	 ...
	 */
	private static native Sprite createSprite(Vector2d position,
			ImageResource res, String animationKey) /*-{
													img = @com.google.gwt.user.client.ui.Image::new(Lcom/google/gwt/safehtml/shared/SafeUri;)(res.@com.google.gwt.resources.client.ImageResource::getSafeUri()()); 
													return new $wnd.Kinetic.Sprite({
													x: position.@net.edzard.kinetic.Vector2d::x,
													y: position.@net.edzard.kinetic.Vector2d::y,
	...
	/**
	 * Create a text shape that follows a SVG path. A SVG path string is made up
	 * from path commands (see <a href="http://www.w3.org/TR/SVG/paths.html">W3C
	 * SVG 1.1 TR</a>).
	 * 
	 * @param position
	 *            The initial position
	 ...
	 * @see PathSVG
	 */
	public static native TextPath createTextPath(Vector2d position,
			String aText, String d) /*-{
	...
	/**
	 * Create a line shape. The line will consist of only two points. Use
	 * {@link Line#setPoints(List)} to set more than two.
	 * 
	 * @param start
	 *            The start point
	 * @param end
	...
	/**
	 * Create a polygonal shape. The created polygon will be a triangle. Use
	 * {@link Polygon#setPoints(List)} to set different shape points.
	 * 
	 * @param a
	 *            First point
	 * @param b
	 ...
	 * @see RegularPolygon
	 */
	public static native RegularPolygon createRegularPolygon(Vector2d position,
			double r, int s) /*-{
	...
	/**
	 * Create a shape that is defined by a SVG path string. A SVG path string is
	 * made up from path commands (see <a
	 * href="http://www.w3.org/TR/SVG/paths.html">W3C SVG 1.1 TR</a>).
	 * 
	 * @param position
	 *            The initial position
	 * @param d
	 ...
	 * @see Star
	 */
	public static native Star createStar(Vector2d position, double innerR,
			double outerR, int num) /*-{
	...
	/**
	 * Create a custom shape. Custom shapes are defined using {@link Path}
	 * objects.
	 * 
	 * @param position
	 *            The initial position
	 ...
	 * 
	 * @param context
	 *            The context layer (animation takes place on this layer)
	 * @param fct
