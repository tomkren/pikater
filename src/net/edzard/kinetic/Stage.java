...
/**
 * Central class for drawing with Kinetic. The stage contains everything that is
 * drawn. It consists of layers, which in turn contain the shapes.
 * 
 * @author Ed
 * @see Layer
 */
public class Stage extends Container {
	...
	/**
	 * Clears the stage. All layers are cleared.
	 */
	...
	/**
	 * Retrieve the user position. This is either a mouse or a touch position.
	 * 
	...
	/**
	 * Get all shapes that intersect with a given point. This works across
	 * layers
	 * 
	 * @param position
	 *            Position to check
	...
	/**
	 * Retrieve a URL to the stage's data. The data url will refer to a PNG
	 * image The data url will be passed by means of a callback
	 * 
	 * @param callback
	 *            A callback handler that will receive the data url
	 */
	...
	/**
	 * Retrieves the throttle value for animations on this stage object. The
	 * throttle value influences how often drawing operations are executed.
	 * 
	...
	/**
	 * Assign a throttle value for animation on this stage object. The throttle
	 * value influences how often drawing operations are executed.
	 * 
	 * @param throttle
