...
/**
 * A text shape. Used for writing text. Text formatting options are limited.
 * There does not seem to be a wrap-around option for text boxes.
 * 
 * @author Ed
 */
// TODO: Use same strategy for doing all of the enumeration literal
// conversions...
// TODO: test the alignment values (are they properly converted to lowercase /
// uppercase?
public class Text extends Shape {
	...
	/**
	 * Retrieve the current text fill colour used by this text shape. The text
	 * fill colour controls the colour of the letters.
	 * 
	...
	/**
	 * Assign a text fill colour to this text shape. The text fill colour
	 * controls the colour of the letters.
	 * 
	 * @param fill
	 *            The text fill colour to set
	 */
	...
	/**
	 * Retrieve the current stroke colour used by the text shape. The text
	 * stroke defines the coulor of the outline of the text.
	 * 
	...
	/**
	 * Assign a text stroke colour to this text shape. The text stroke defines
	 * the coulor of the outline of the text.
	 * 
	 * @param stroke
	 *            A text stroke colour
	 */
	...
	/**
	 * Retrieve the text stroke width used by this text shape. The text stroke
	 * width defines the width of the text's outline.
	 * 
	...
	/**
	 * Assigns a text stroke width for this text shape. The text stroke width
	 * defines the width of the text's outline.
	 * 
	 * @param width
	 *            A text stroke width
	 */
