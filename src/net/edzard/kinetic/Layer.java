...
/**
 * A layer object. Layers contain nodes. Multiple layers can be assigned to a
 * stage. Each will be drawn individually and combined into a single overall
 * drawing. By restricting shapes to certain layers, update operations can be
 * kept to a minimum, which is good for performance.
 * 
 * @author Ed
 */
public class Layer extends Container {
	...
	/**
	 * Retrieves the throttle value for animations on this layer object. The
	...
	/**
	 * Assign a throttle value for animation on this layer object. The throttle
