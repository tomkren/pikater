...
/**
 * A polygon shape. Polygons are defined by an arbitrary number of points.
 * 
 * @author Ed
 */
public class Polygon extends Shape {
	 ...
	 * 
	 * @param num
	 *            The index number of the point to retrieve. There are no
	 ...
	 * 
	 * @param num
	 *            The index number of the point to change. It has to exist.
	 * @param position
	 *            The new position to assign
	 */
