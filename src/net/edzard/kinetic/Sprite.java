...
/**
 * A sprite shape. Sprites display animation sequences. Animation sequences have
 * an identifying name and consist of a sequence of frames. Frames are defined
 * using cropping areas on a single, large image.
 * 
 * @author Ed
 */
public class Sprite extends Shape {
	 ...
	 * 
	 * @param res
	 *            A resource referring to the image to use
	 */
	 ...
	 * 
	 * @param img
	 *            An image to use. Does not support picture inlining.
	 */
	 ...
	 * 
	 * @param key
	 *            An existing animation sequence name
	 */
	 ...
	 * 
	 * @return A map of animation sequences. Each sequence consists of an
	 *         ordered list of frames (cropping areas referring to the image)
	 */
	 ...
	 *            A map of animation sequences. Each sequence consists of an
	 *            ordered list of frames (cropping areas referring to the image)
	 */
	...
	/**
	 * Retrieve the frame rate. The frame rate defines how many frames should be
	...
	/**
	 * Assign the frame rate. The frame rate defines how many frames should be
	 * displayed per second.
	 * 
	 * @param rate
	 *            A frame rate
