 ...
 */
@Entity
@Table(name = "FileMapping", indexes = { @Index(columnList = "internalfilename"), @Index(columnList = "externalfilename") })
@NamedQueries({ @NamedQuery(name = "FileMapping.getAll", query = "select fm from JPAFilemapping fm"),
