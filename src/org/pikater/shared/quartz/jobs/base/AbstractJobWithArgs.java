		...
		if ((index >= 0) && index < numArgs) {
			if (executionContext != null) {
				...
				try {
					...
					throw new JobExecutionException(String.format("Argument number %d is of type '%s' and can not be cast to the type you provided. " + "Recheck your bindings.", index, result
							.getClass().getName()));
				}
			} else {
