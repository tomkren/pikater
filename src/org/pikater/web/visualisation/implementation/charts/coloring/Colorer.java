...
/**
 * Interface representing functions necessary for points' color represenation in the charts. 
 * 
 * @author siposp
 * 
 */
public interface Colorer {
	 ...
	 * @param value to be converted to a color
	 ...
	 * @throws ColorerNotMergeableException when two incompatible colorers are intended to be merged
	 */
