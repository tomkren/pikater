...
/**
 * <p>
 * This class represents additional functionality, that make possible to compare data entries
 * of two individual datasets.
 * </p>
 * <p>
 * In this case, we use terminology, as follows:
 * <ul>
 * <li>Primary dataset - dataset that is represented using circles as for visualisation of single dataset</li>
 * <li>Secondary dataset - dataset that is represented using squares to distinguish between the dataset</li>
 * </ul>
 * </p>
 * 
 * @author siposp
...
public class ComparisonChart extends SingleChart {
	 ...
	 * @param width of the chart in pixels
	 * @param height of the chart in pixels
	 * @param renderer {@link RendererInterface} used to draw the chart
	 * @param horizontalAxis {@link Axis} representing axis X
	 * @param verticalAxis {@link Axis} representing axis Y
	 */
	 ...
	 * @param pointWidth width of square in pixels
	 * @param colorer used to genereate the point's color based on its value
	 */
	...
	/**
	 * Draws a square with specified parameters, that represents a data entry for the secondary datasets.
	 * @param x coordinate in chart space
	 * @param y coordinate in chart space
	 * @param z value of the point
	 * @param pointWidth width of square in pixels
	 * @param color the point is filled with
	 */
