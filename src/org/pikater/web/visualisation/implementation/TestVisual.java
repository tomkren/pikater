...
public class TestVisual {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			ComparisonPNGGenerator csvggiris = new ComparisonPNGGenerator(dummyResult, new PrintStream("core/datasets/visual/sIRIS_sepallength_petallength_class_c.png"), iris1, iris2, iris1file,
					iris2file, attr1, attr1, attr2, attr2, attr3, attr3);
			csvggiris.create();
		} catch (Exception e) {
