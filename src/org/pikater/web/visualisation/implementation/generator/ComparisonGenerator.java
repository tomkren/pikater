...
public abstract class ComparisonGenerator extends Generator {
	...
	public ComparisonGenerator(AbstractDSVisResult<?, ?> progressListener, PrintStream output, JPADataSetLO dslo1, JPADataSetLO dslo2, int XIndex1, int XIndex2, int YIndex1, int YIndex2,
	...
	public ComparisonGenerator(AbstractDSVisResult<?, ?> progressHandler, PrintStream output, JPADataSetLO dslo1, JPADataSetLO dslo2, String XName1, String XName2, String YName1, String YName2,
			String ColorName1, String ColorName2) {
	...
	public ComparisonGenerator(AbstractDSVisResult<?, ?> progressHandler, PrintStream output, JPADataSetLO dslo1, JPADataSetLO dslo2, File datasetCachedFile1, File datasetCachedFile2, String XName1,
