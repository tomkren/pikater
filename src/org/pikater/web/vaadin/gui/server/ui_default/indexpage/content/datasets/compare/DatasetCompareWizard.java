...
public class DatasetCompareWizard extends WizardForDialog<DatasetCompareCommons> implements IDialogComponent {
	...
	public boolean isResultReadyToBeHandled() {
		...
		attrComps_original = getCompatibleAttributes(getOutput().getDatasetOriginal(), getOutput().getFormOriginal().getSelectedAttributes(), getOutput().getFormOriginal()
				.getSelectedTargetAttribute());
		attrComps_compared = getCompatibleAttributes(getOutput().getDatasetCompareTo(), getOutput().getFormCompareTo().getSelectedAttributes(), getOutput().getFormCompareTo()
				.getSelectedTargetAttribute());
