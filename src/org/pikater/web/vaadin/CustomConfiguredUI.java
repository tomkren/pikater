...
public abstract class CustomConfiguredUI extends UI {
	...
	protected void returnErrorCode(int errorCode, String message) {
		try {
			...
			PikaterWebLogger.logThrowable(String.format("UI could not be created but writing an error code of '%d' " + "to the response failed because of the following exception. Vaadin should have "
