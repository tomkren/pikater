package org.pikater.web.unused.components.console;
...
import org.pikater.web.unused.ssh.SSHRemoteExec;
...
public class SimpleConsoleComponent extends VerticalLayout
{
	...
	*/
	 ...
	 * @see org.pikater.web.unused.ssh.SSHRemoteExec#execSync(String command)
	 */
