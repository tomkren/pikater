...
public interface Operator {
    ...
    /**
     * Performs the genetic operator. 
     * 
     * Crossover should take the parents in pair from the {@code parents} population,
     * clone them, perform the operation and put the offspring into the {@code offspring} population.
     * 
