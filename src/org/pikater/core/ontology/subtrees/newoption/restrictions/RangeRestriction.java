...
public class RangeRestriction implements IRestriction {
	...
	public RangeRestriction(IComparableValueData minValue,
			IComparableValueData maxValue) {
	...
	public boolean isMasterRangeOf(RangeRestriction other) {
		if (isValid() && other.isValid()
				&& fetchRangeType().equals(other.fetchRangeType())) {
			if (isFullySpecified() != other.isFullySpecified()) {
				return false;
			} else {
				// ranges with only opposite bounds defined can not be
				// compatible
				if (!isFullySpecified()) {
				...
				if ((minValue != null) && (other.getMinValue() != null)
						&& (minValue.compareTo(other.getMinValue()) > 0)) {
					return false;
				}
				if ((maxValue != null) && (other.getMaxValue() != null)
						&& (other.getMaxValue().compareTo(maxValue) > 0)) {
					return false;
				}
				return true;
			}
	...
	public boolean validatesValue(IComparableValueData value) {
		if (isValid()) {
			if ((minValue != null)
					&& minValue.getClass().equals(value.getClass())
					&& (minValue.compareTo(value) > 0)) {
				return false;
			}
			if ((maxValue != null)
					&& maxValue.getClass().equals(value.getClass())
	...
	public boolean isValid() {
		if ((minValue == null) && (maxValue == null)) {
			return false;
				...
				&& (!minValue.getClass().equals(maxValue.getClass())
	...
	public RangeRestriction clone() {
		...
		IComparableValueData minValueClone = null;
		if (minValue != null) {
			minValueClone = minValue.clone();
		}
		IComparableValueData maxValueClone = null;
		if (maxValue != null) {
			maxValueClone = maxValue.clone();
		}
		result.setMinValue(minValueClone);
		result.setMaxValue(maxValueClone);
		return result;
	}
}
