...
public enum CoreAgents {
	...
	INITIATOR("Initiator"), DATA_MANAGER("DataManager"), GUI_AGENTS_COMMUNICATOR(
			"GuiAgentsCommunicator"), ARFF_READER("ARFFReader"), MANAGER_AGENT(
			"ManagerAgent"), MANAGER("Manager"), COMPUTING_AGENT(
			"ComputingAgent"), PLANNER("Planner"), GUI_AGENT("GUIAgent"), GUI_KLARA_AGENT(
