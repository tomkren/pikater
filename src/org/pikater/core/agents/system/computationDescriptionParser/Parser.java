...
public class Parser {
    ...
    public void parseFileDataProvider(FileDataProvider file, ComputationNode child, String connectionName) {
        ...
        {
            alreadyProcessed.put(file, new ComputationNode());

        }
        ComputationNode fileNode=alreadyProcessed.get(file);
        ...
        fileNode.addBufferToOutput(connectionName, buffer);

        computationGraph.addNode(fileNode);
    }
