...
/**
 * Computation node for executing ML experiments User: Kuba Date: 18.5.2014
 * Time: 15:52
 */
public class ModelComputationNode extends ComputationNode {
	...
	public void numberOfTasksChanged() {
		...
		if (numberOfTasksInProgress == 0) {
			...
			DataManagerService.updateExperimentStatus(this.agent, experimentID,
					JPAExperimentStatus.FINISHED.name());
