...
public class ExperimentItem {
	...
	public List<ExperimentItem> getIndependentItems() {
		...
		// If this Item is not waiting in queue, than his sons are not waiting
		// to
		...
		List<ExperimentItem> problems = new ArrayList<ExperimentItem>();
		...
		for (ExperimentItem problem : dependentSons) {
			...
			List<ExperimentItem> problemsI = problem.getDependentSons();
