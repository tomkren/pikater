...
public interface Comb0 {
    ...
    static Comb0 mkTypedDag(TypedDag dag) {return fakeInputs -> dag;}

    static Comb0 mkTypedDagFun2(BiFunction<TypedDag,TypedDag,TypedDag> f) {
        return inputs -> f.apply((TypedDag)inputs.get(0),(TypedDag)inputs.get(1));
    }

    static Comb0 mkTypedDagFun3(TriFun<TypedDag,TypedDag,TypedDag,TypedDag> f) {
