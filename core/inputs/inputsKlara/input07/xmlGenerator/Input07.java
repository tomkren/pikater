...
public final class Input07 {
	...
	public static ComputationDescription createDescription() {
		...
		comAgent1.setEvaluationMethod(new EvaluationMethod(CrossValidation.class.getName()));
		...
		comAgent2.setEvaluationMethod(new EvaluationMethod(CrossValidation.class.getName()));
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String fileName = CoreConfiguration.INPUTS_KLARA_PATH + "input07"
