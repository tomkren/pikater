...
Databáze Postgre se používá společně s JPA frameworkem pro ukládání JAVAových objektů pomocí objektově relačního mapování. Soubory jsou ukládány jako LargeObjekty.
